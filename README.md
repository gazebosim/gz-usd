...
* [USD](https://github.com/PixarAnimationStudios/USD/tree/v22.11#getting-and-building-the-code):
    ...
    ```bash
    git clone --depth 1 -b v22.11 https://github.com/PixarAnimationStudios/USD.git
    ```
    Note: Only v22.11 supported currently
