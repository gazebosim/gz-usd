...
class UsdJointStageFixture : public::testing::Test
{
  ...
  public: void GenerateUSD(const std::string &_sdfFile)
  {
    ...
    ASSERT_TRUE(gz::testing::LoadSdfFile(_sdfFile, this->root));
...
{
  this->GenerateUSD(gz::testing::TestFile("sdf", "double_pendulum.sdf"));
...
{
  this->GenerateUSD(gz::testing::TestFile("sdf", "joint_parent_world.sdf"));
...
{
  this->GenerateUSD(gz::testing::TestFile("sdf", "ball_prismatic_joint.sdf"));
