...
#ifndef IGNITION_USD_USD_IGNITION_USD_PARSER_COLLISION_HH_
#define IGNITION_USD_USD_IGNITION_USD_PARSER_COLLISION_HH_
...
namespace ignition
{
  ...
  namespace usd
  {
    ...
    /// indicates no error.
    ignition::usd::UsdErrors ParseSdfCollision(
